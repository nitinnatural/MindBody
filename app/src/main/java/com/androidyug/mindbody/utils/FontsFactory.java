package com.androidyug.mindbody.utils;
...
public class FontsFactory {
    ...
    public static Typeface lobsterRegular(Context ctx){
        Typeface tf = Typeface.createFromAsset(ctx.getAssets(), "fonts/Lobster-Regular.ttf");
        return tf;
    }
}
