...
public interface ApiEndpointInterface {
    ...
    @GET("explore")
    Call<Response> getFitnessCenter(@Query("ll") String latlong, @Query("radius") int radiusMeter, @Query("query") String query, @Query("client_id") String clientId, @Query("client_secret") String clinetSecret, @Query("v") String version);
    ...
    @GET("/{venueId}")
    Call<ResponseBody> getVenueDetail( @Path("venueId") String venueId, @Query("client_id") String clientId, @Query("client_secret") String clientSecret, @Query("v") String version);
